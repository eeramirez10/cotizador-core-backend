...
export class CustomerResponseDto {
  ...
  toJSON() {
    return {
      ...
      billingExteriorNumber: this.customer.billingExteriorNumber,
      billingInteriorNumber: this.customer.billingInteriorNumber,
      billingNeighborhood: this.customer.billingNeighborhood,
      ...
      contacts: this.customer.contacts.map((contact) => ({
        id: contact.id,
