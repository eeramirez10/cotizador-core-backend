  ...
  async createLocalTemp(params: CreateLocalTempProductDatasourceParams): Promise<ProductEntity> {
    const row = await prisma.product.create({
      data: {
        ...
        commercialDescription: params.commercialDescription,
        family: params.family,
        subfamily: params.subfamily,
        brand: params.brand,
        technicalAttributes: params.technicalAttributes,
        unit: params.unit,
  ...
  async updateLocalTempById(params: UpdateLocalTempProductDatasourceParams): Promise<ProductEntity | null> {
    ...
    const row = await prisma.product.update({
      ...
      data: {
        ...
        commercialDescription: params.data.commercialDescription,
        ...
        costStatus: params.data.costStatus,
        costSource: params.data.costSource,
    ...
    if (params.search) {
      andFilters.push({
        OR: [
          ...
          { commercialDescription: { contains: params.search, mode: "insensitive" } },
          { family: { contains: params.search, mode: "insensitive" } },
          { subfamily: { contains: params.search, mode: "insensitive" } },
